                        ...
                        switch(screen.main[a][b]){
                            case '(':
                                if(dist(inputs.mouse.x,inputs.mouse.y,
                                    (10+b*20-screen.main[0].length*10)*min(30/screen.main[0].length/10*(1+game.enter.anim*41/7)+graphics.full.width/2,30/screen.main.length/10*(1+game.enter.anim*41/7)+graphics.full.height/2),
                                    (10+a*20-screen.main.length*10)*min(30/screen.main[0].length/10*(1+game.enter.anim*41/7)+graphics.full.width/2,30/screen.main.length/10*(1+game.enter.anim*41/7)+graphics.full.height/2)<200/min(screen.main[0].length/10,screen.main.length/10)*(1+game.enter.anim*41/7))){
