...
grouping={complete:false,add:false,create:2,fail:false,screen:[],size:[],star:[],dot:[]}
screen={main:[],active:[],fade:[],error:[],flash:[],generate:[],remember:[],trigger:false,start:[0,0],position:[0,0],complete:false,symmetry:0}
